...
echo "-----------------------------------------------"
runjava -f scripts/evaluatePip.dml -stats -args "," ../data/movie/train.csv ../data/movie/test.csv meta/meta_movie.csv ./ FALSE evalClassification .

echo -e "\n1.Top-k without SliceLine (sf = 0.5)"
echo "---------------------------------------"
runjava -f scripts/topkMovie.dml -stats -nvargs sep="," dirtyData=../data/movie/train.csv metaData=meta/meta_movie.csv primitives=properties/primitives.csv parameters=properties/param.csv sample=0.5 topk=3 expectedIncrease=10 max_iter=15 rv=50 enablePruning=TRUE testCV=TRUE cvk=3 split=0.7 seed=42 func=evalClassification sliceline=FALSE output=.
cat pip.csv
...
echo "---------------------------------------"
runjava -f scripts/topkMovie.dml -stats -nvargs sep="," dirtyData=../data/movie/train.csv metaData=meta/meta_movie.csv primitives=properties/primitives.csv parameters=properties/param.csv sample=0.1 topk=3 expectedIncrease=10 max_iter=15 rv=50 enablePruning=TRUE testCV=TRUE cvk=3 split=0.7 seed=42 func=evalClassification sliceline=FALSE output=.
cat pip.csv
...
echo "---------------------------------------"
runjava -f scripts/topkMovie.dml -stats -nvargs sep="," dirtyData=../data/movie/train.csv metaData=meta/meta_movie.csv primitives=properties/primitives.csv parameters=properties/param.csv sample=0.01 topk=3 expectedIncrease=10 max_iter=15 rv=50 enablePruning=TRUE testCV=TRUE cvk=3 split=0.7 seed=42 func=evalClassification sliceline=FALSE output=.
cat pip.csv
...
sed -i '/WARN\|INFO/d' outMovie.log
