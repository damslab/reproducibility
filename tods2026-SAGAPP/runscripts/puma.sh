...
echo "-----------------------------------------------"
runjava -f scripts/evaluatePip.dml -stats -args "," ../data/puma/train.csv ../data/puma/test.csv meta/meta_puma.csv ./ FALSE evalClassification .

echo -e "\n1.Top-k without SliceLine (sf = 0.5)"
echo "---------------------------------------"
runjava -f scripts/topkPuma.dml -stats -nvargs sep="," dirtyData=../data/puma/train.csv metaData=meta/meta_puma.csv primitives=properties/primitives.csv parameters=properties/param.csv sample=0.5 topk=3 expectedIncrease=10 max_iter=15 rv=50 enablePruning=TRUE testCV=TRUE cvk=3 split=0.7 seed=42 func=evalClassification sliceline=FALSE output=.
cat pip.csv
...
echo "---------------------------------------"
runjava -f scripts/topkPuma.dml -stats -nvargs sep="," dirtyData=../data/puma/train.csv metaData=meta/meta_puma.csv primitives=properties/primitives.csv parameters=properties/param.csv sample=0.1 topk=3 expectedIncrease=10 max_iter=15 rv=50 enablePruning=TRUE testCV=TRUE cvk=3 split=0.7 seed=42 func=evalClassification sliceline=FALSE output=.
cat pip.csv
...
echo "---------------------------------------"
runjava -f scripts/topkPuma.dml -stats -nvargs sep="," dirtyData=../data/puma/train.csv metaData=meta/meta_puma.csv primitives=properties/primitives.csv parameters=properties/param.csv sample=0.01 topk=3 expectedIncrease=10 max_iter=15 rv=50 enablePruning=TRUE testCV=TRUE cvk=3 split=0.7 seed=42 func=evalClassification sliceline=FALSE output=.
cat pip.csv
