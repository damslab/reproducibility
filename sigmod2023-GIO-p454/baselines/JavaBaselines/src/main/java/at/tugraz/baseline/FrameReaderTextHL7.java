...
public class FrameReaderTextHL7 extends FrameReader {
	...
	protected FrameBlock computeSizeAndCreateOutputFrameBlock(TextInputFormat informat, JobConf job,
		ValueType[] schema, String[] names, InputSplit[] splits, String beginToken)
		throws IOException, DMLRuntimeException {
		_rLen = 0;
		_cLen = names.length;
	...
	private static void addRow(String messageString, PipeParser pipeParser, FrameBlock dest, ValueType[] schema, int row) throws IOException {
	...
	protected static int readHL7FrameFromInputSplit(TextInputFormat informat, InputSplit split,  int splitCount, ValueType[] schema, FrameBlock dest) throws IOException {
