...
def parse(file, col={"kmeans+": 1, "PCA+": 3, "mLogReg+": 5}):
    ...
    row ={
        ...
        "train_census_enc    ,l2svmml             ,ula-sysmlb16-singlenode-spark ":0,
        "train_census_enc    ,l2svmml             ,cla-sysmlb16-singlenode-spark ":1,
    ...
    row128 = {
        ...
        "train_census_enc_256x,l2svmml             ,ula-sysmlb16-hybrid-spark":0,
        "train_census_enc_256x,l2svmml             ,cla-sysmlb16-hybrid-spark":1,
        "census_enc_256x_16k ,l2svmml             ,ulab16-hybrid             ":2,
        "census_enc_256x_16k ,l2svmml             ,clab16-hybrid             ":3,
        "census_enc_256x_16k ,l2svmml             ,claWorkloadb16-hybrid     ":4
    }


    row128len = len("train_census_enc_128x,l2svmml             ,cla-sysmlb16-hybrid-spark")
    rowlen = len("census_enc_16k      ,l2svmml             ,ulab16-hybrid                 ")
...
for machine in machinesList:
    ...
    # print(d)
    with open("plots/tables/sysml_alg_"+machine+"_v2.tex", "w") as f:
