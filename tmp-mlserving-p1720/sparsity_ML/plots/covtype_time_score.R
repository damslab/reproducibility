...
pdf(file="covtype_time_score.pdf",
    width=4.8, height=4, family="serif", pointsize=14)
#par(mar=c(3.5, 4, 2.5, 2) + 0.1)

data1 = rowMeans(matrix(as.matrix(read.table("covtype_time_score.dat", 
...
text(x=25, y=30, labels="Baseline Accuracy: 0.74")
text(x=25, y=15, labels="Accuracy Drop: < 4%")
