...
pdf(file="criteo_time_score.pdf",
    width=4.8, height=4, family="serif", pointsize=14)
#par(mar=c(3.5, 4, 2.5, 2) + 0.1)

data1 = rowMeans(matrix(as.matrix(read.table("criteo_time_score.dat", 
...
text(x=15, y=140, labels="Baseline Accuracy: 0.96")
text(x=15, y=60, labels="Accuracy Drop: < 2%")
