...
lossy = ("full", "l1", "l2", "l3", "l5", "l10", "l20", "l40", "l80", "l160", "l320", "l640", "l1280", "l2560")
# l1 l2 l3 l5 l10 l20 l40 l80 l160 l320 l640 l1280 l2560

mkdir("./plotting/tables/20-LMLossy")
...
for m in machines:
    baseRegression = "results/lossy_alg/" + m + "/regress_lm/code/conf/"
    baseClassification = "results/lossy_alg/" + m + "/binary_lm_1/code/conf/"
    baseClassification2 = "results/lossy_alg/" + m + "/binary_lm_last/code/conf/"
    out = "plotting/tables/20-LMLossy/" + m + ".csv"
    print("TableScript:", "plotting/scripts/table_20_lossyLM.py", "out:", out)
    with open(out, "w") as cv:
        cv.write("name,")
        cv.write("Conf,FileType,lossy,")
        cv.write(
