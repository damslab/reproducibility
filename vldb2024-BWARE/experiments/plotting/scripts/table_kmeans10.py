...
base = "results/e2e/criteo_kmeans10/code/conf/"
...
mkdir("./plotting/tables/kmeans10/")
mkdir("./plotting/tables/kmeans10/criteo")

for m in machines:
    with open("plotting/tables/kmeans10/criteo/log_" + m + ".csv", "w") as cv:
        cv.write(
