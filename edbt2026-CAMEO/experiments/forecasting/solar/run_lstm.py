...
def main():
    ...
    model = BlockRNNModel(input_chunk_length=lookback, output_chunk_length=lookback,
                          hidden_dim=64, n_epochs=10, model='LSTM')
    ...
    pmc_results.to_csv('results/solar/lstm_solar_pmc_results.csv')
    area_results.to_csv('results/solar/lstm_solar_area_results.csv')
    acf_results.to_csv('results/solar/lstm_solar_acf_results.csv')
