...
def main():
    ...
    for error in [0.4, 0.7, 0.8, 0.9, 1.0, 1.5, 2.0, 2.5, 2.55, 2.6]:
        ...
        model = TransformerModel(
                    ...
                    batch_size=32,
                    n_epochs=10,
                    model_name="mt_pmc_trans%f"%error,
                    nr_epochs_val_period=2,
                    d_model=16,
                    nhead=8,
                    num_encoder_layers=2,
    ...
    for error in acf_acf_errors:
        ...
        model = TransformerModel(
                ...
                batch_size=32,
                n_epochs=10,
                model_name="mt_sip_trans%f"%error,
                nr_epochs_val_period=2,
                d_model=16,
                nhead=8,
                num_encoder_layers=2,
    ...
    for error in area_acf_errors:
        ...
        model = TransformerModel(
                ...
                batch_size=32,
                n_epochs=10,
                model_name="mt_vw_trans%f"%error,
                nr_epochs_val_period=2,
                d_model=16,
                nhead=8,
                num_encoder_layers=2,
    ...
    area_results.to_csv('results/min_temp/transformer_mintemp_area_results.csv')
    acf_results.to_csv('results/min_temp/transformer_mintemp_acf_results.csv')
    pmc_results.to_csv('results/min_temp/transformer_mintemp_pmc_results.csv')
