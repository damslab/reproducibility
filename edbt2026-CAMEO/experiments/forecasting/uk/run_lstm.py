...
def main():
    ...
    model = BlockRNNModel(input_chunk_length=lookback, output_chunk_length=lookback,
                          hidden_dim=64, n_epochs=10, model='LSTM', random_state=42)
    ...
    # for error in [0.001, 0.005, 0.01, 0.015, 0.02, 0.03, 0.04, 0.05, 0.07, 0.08, 0.09, 0.1]:
    for error in [0.001, 0.005, 0.01, 0.015, 0.02, 0.03, 0.04, 0.05, 0.07, 0.08, 0.09, 0.1]:
        compressor = LineSimplification()
    ...
    area_results.to_csv('results/uk/lstm_uk_area_results.csv')
    acf_results.to_csv('results/uk/lstm_uk_acf_results.csv')
    pmc_results.to_csv('results/uk/lstm_uk_pmc_results.csv')
