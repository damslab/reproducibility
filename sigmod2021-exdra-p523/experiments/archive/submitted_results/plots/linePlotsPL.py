...
for alg in algorithms:
    ...
    try:
        ...
        lower = ma - mstd
        upper = ma + mstd
        ax[plotId].fill_between([0, 1, 2, 3, 4, 5, 6], lower[:7], upper[:7], alpha=0.2)
    ...
    # markerId += 1
    # ma, local_ma, mstd, local_mstd = parse(
    #     "plots/" + args.data + "_" + alg + "_XPS-15-7590_sslmkl_table.csv"
    # )
    # ax[plotId].plot(
    #     [0, 1, 2, 3, 4, 5, 6],
    #     ma[:7],
    ...
    # markerId += 1
    # if alg == "TwoNN":
    #     ma, local_ma, mstd, local_mstd = parse("plots/" + args.data + "_"+alg + "_XPS-15-7590_sslmkl_table.csv")
