...
def plot(df, m):
    ...
    axi.tick_params(axis="y", pad=-0.06)
    # axi[1].legend(
    ...
    fig.text(0.003, 0., "#Row→", fontsize=6)
    # fig.text(0.0,0.,"# Rows", fontsize=4)

    plt.subplots_adjust(
        left=0.25, right=0.99, top=0.76, bottom=0.136, wspace=0.07, hspace=0.30
    )
