...
_, ax = plt.subplots(
    1, 2, num=None, figsize=(3-0.3, 0.8), dpi=pu.dpi, facecolor="w", edgecolor="k"
)
...
cb = plt.colorbar(im, ticks = [1,10], format = mticker.FixedFormatter(["1","10"]))
...
plt.subplots_adjust(left=-0.02, right=0.9, top=0.94,
	                        bottom=0.05, wspace=0.01, hspace=0.1)
out = "plotting/plots/micro/correlation.pdf"
print("script:", "plotting/scripts/plot_corr.py", "out" ,out )
