...
add2("Criteo",[2, 31350, 8001, 1459, 29994, 4123, 866, 610, 11570, 1642, 15, 225, 725558, 4671, 18576837, 29427, 15127, 7295, 19901, 3, 6465, 1310, 61, 11700067, 622921, 219556, 10, 2209, 9779, 71, 4, 963, 14, 22022124, 4384510, 15960286, 290588, 10829, 95, 34], 195841983 )
...
for idx,ax in enumerate(axi):
	...
	ytics = pu.set_tics_y_log10(ax,0.000008, 120)
...
fig.supxlabel('Distinct Columns',y=-0.02, size= 8)

axi[0].yaxis.set_label_coords(-0.89, 0.5)
axi[0].tick_params(axis="y", pad=-0.06)
plt.subplots_adjust(left=0.145, right=0.996, top=0.93,
                        bottom=0.13, wspace=0.17, hspace=0.30)
# plt.show()
