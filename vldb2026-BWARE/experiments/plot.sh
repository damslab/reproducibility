...
python plotting/scripts/table_26_wordemb.py & 
python plotting/scripts/table_26_wordemb_nn.py & 
python plotting/scripts/table_27_wordemb_random.py & 
python plotting/scripts/table_28_wordemb_nn.py &
...
python ./plotting/scripts/plot_26_wordemb.py & 
python ./plotting/scripts/plot_27_wordemb_random.py & 

python ./plotting/scripts/plot_28_transformEncodeBreakdown.py & 
