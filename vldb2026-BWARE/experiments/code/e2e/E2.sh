...
run() {
    ...
    echo "REDUCED Number of executors!"
    export SYSTEMDS_DISTRIBUTED_OPTS="\
			--master yarn \
			--deploy-mode client \
			--driver-memory 900g \
			--conf spark.driver.extraJavaOptions=\"\
				-Xms900g -Xmn100g -Dlog4j.configuration=file:$LOG4JPROP				-agentpath:$HOME/Programs/profiler/lib/libasyncProfiler.so=start,event=cpu,file=$profile				\" \
...
run criteo_kmeans ULAb1 hybrid data/criteo/day_0.bin $spec
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_1.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_2.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_3.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_4.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_6.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_7.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_8.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_9.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_10.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_11.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_12.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_13.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_14.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_15.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_16.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_17.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_18.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_19.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_20.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_21.bin $spec $test
# run criteo_kmeans ULAb1 hybrid data/criteo/days_1_22.bin $spec $test

run criteo_kmeans TAWAb1 hybrid data/criteo/day_0.bin $spec
# run criteo_kmeans TAWAb1 hybrid data/criteo/days_1_1.bin $spec $test
# run criteo_kmeans TAWAb1 hybrid data/criteo/days_1_2.bin $spec $test
# run criteo_kmeans TAWAb1 hybrid data/criteo/days_1_3.bin $spec $test
