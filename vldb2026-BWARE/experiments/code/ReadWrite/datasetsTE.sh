...
# run1 $fullLogName-adult-FM.log $file ULA mtd_te 16 $spec
...
# run1 $fullLogName-adult-uf.log $file ULA mtd_detect 16
# run $fullLogName-adult-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
# removetmp $file

# run1 $fullLogName-adult-cf.log $file ULA mtd_compress 16
...
# # run1 $fullLogName-cat-FM.log $file ULA mtd_te 16 $spec
...
# removetmp $file
# run1 $fullLogName-cat-uf.log $file ULA mtd_detect 16
# run $fullLogName-cat-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
# removetmp $file
# run1 $fullLogName-cat-cf.log $file ULA mtd_compress 16
...
# run1 $fullLogName-kdd-FM.log $file ULA mtd_te 16 $spec
...
# run1 $fullLogName-kdd-uf.log $file ULA mtd_detect 16
# run $fullLogName-kdd-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
# removetmp $file

# run1 $fullLogName-kdd-cf.log $file ULA mtd_compress 16
...
# # run1 $fullLogName-salaries-FM.log $file ULA mtd_te 16 $spec
...
# run1 $fullLogName-salaries-uf.log $file ULA mtd_detect 16
# run $fullLogName-salaries-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
# removetmp $file

# run1 $fullLogName-salaries-cf.log $file ULA mtd_compress 16
...
# run1 $fullLogName-santander-FM.log $file ULA mtd_te 16 $spec
...
run1 $fullLogName-santander-uf.log $file ULA mtd_detect 16
run $fullLogName-santander-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
removetmp $file

run1 $fullLogName-santander-cf.log $file ULA mtd_compress 16
...
# # run1 $fullLogName-home-FM.log $file ULA mtd_te 16 $spec
...
# run1 $fullLogName-home-uf.log $file ULA mtd_detect 16
# run $fullLogName-home-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
# removetmp $file

# run1 $fullLogName-home-cf.log $file ULA mtd_compress 16
...
# run1 $fullLogName-crypto-FM.log $file ULA mtd_te 16 $spec
...
# run1 $fullLogName-crypto-uf.log $file ULA mtd_detect 16
# run $fullLogName-crypto-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
# removetmp $file

# run1 $fullLogName-crypto-cf.log $file ULA mtd_compress 16
...
# run1 $fullLogName-criteo-FM.log $file ULA mtd_te 16 $spec
...
run1 $fullLogName-criteo-uf.log $file ULA mtd_detect 16
run $fullLogName-criteo-RFCMCD.log $file.tmp TCLA mtd_te_compress 16 $spec
removetmp $file

run1 $fullLogName-criteo-cf.log $file ULA mtd_compress 16
